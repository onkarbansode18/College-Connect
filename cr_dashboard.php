<?php 
session_start();  
// Check if user is logged in and is a CR 
if (!isset($_SESSION['user']) || $_SESSION['user']['role'] !== 'crs') {     
    ...
    <div class="dashboard">         
        <div class="sidebar">             
            ...
            <ul class="tabs">                 
                ...
                <li><a href="?feature=manage_announcements">Manage Announcements</a></li>                 
                <li><a href="?feature=view_attendance">View Attendance</a></li>                 
                <li><a href="?feature=mark_attendance">Mark Attendance</a></li>                 
                <li><a href="?feature=study_material">Study Material</a></li>                 
                <li><a href="?feature=view_test_marks">View Test Marks</a></li>                 
