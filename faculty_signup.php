...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name) || empty($email) || empty($password) || empty($subject) || empty($mobile_no)) {
        ...
        $sql = "INSERT INTO faculty (name, email, password, dept, subject, mobile_no)
                VALUES ('$name', '$email', '$password', '$dept', '$subject', '$mobile_no')";
...
<body>
    <div class="container">
        <div class="info-section">
            ...
            <p>Join our platform to manage your courses, communicate with students, and access academic resources.</p>
        </div>
